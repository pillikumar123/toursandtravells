...
class AddRoommateRequest extends Component{
constructor(){
    super();
    ...
    else
    {
        ...
        return(
            <form className="form-signin" onSubmit={this.onSubmit}>
                ...
                <h1 className="h3 mb-3 font-weight-normal section-title">travell Request</h1>
                ...
                <div className="mt-3">
                    <input name="numberofRoommates" value={this.state.request.numberofRoommates} onChange={this.onChange} onBlur={this.onBlur} type="text" id="numberofRoommates" className="form-control" placeholder="numberofpersons"/>
...
export default AddRoommateRequest;