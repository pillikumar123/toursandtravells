                                ...
                                <div className="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
                                    <div className="footer_nav">
                                        <ul className="footer_nav_list">
                                            ...
                                            <li className="footer_nav_item"><a href="/about">about us</a></li>
                                            <li className="footer_nav_item"><a href="/new_Offers">offers</a></li>
                                            <li className="footer_nav_item"><a href="/blog">News</a></li>
                                            <li className="footer_nav_item"><a href="/contact">contact</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
